...
vehicle_models_years = {
  "Toyota" => ["Camry", "Corolla", "RAV4", "Highlander", "Tacoma", "4Runner", "Sienna", "Prius", "Avalon", "Land Cruiser", "Venza", "C-HR"],
  "Ford" => ["F-150", "Escape", "Explorer", "Focus", "Mustang", "Fusion", "Edge", "Expedition", "Ranger", "Bronco", "Maverick", "EcoSport"],
  "Chevrolet" => ["Silverado 1500", "Equinox", "Tahoe", "Suburban", "Traverse", "Malibu", "Camaro", "Colorado", "Blazer", "Trailblazer", "Spark", "Bolt EV"],
  "Honda" => ["Civic", "Accord", "CR-V", "Pilot", "Odyssey", "HR-V", "Fit", "Ridgeline", "Passport", "Insight", "Clarity", "Element"],
  "Nissan" => ["Rogue", "Altima", "Sentra", "Frontier", "Pathfinder", "Versa", "Maxima", "Titan", "Murano", "Kicks", "Armada", "Leaf"],
  "Jeep" => ["Wrangler", "Grand Cherokee", "Cherokee", "Compass", "Renegade", "Gladiator", "Wrangler Unlimited", "Liberty", "Patriot", "Commander", "Wagoneer", "Grand Wagoneer"],
  "Subaru" => ["Outback", "Forester", "Crosstrek", "Impreza", "Legacy", "WRX", "Ascent", "BRZ", "Baja", "Tribeca", "SVX", "Loyale"],
  "BMW" => ["3 Series", "5 Series", "X3", "X5", "X1", "4 Series", "X7", "7 Series", "2 Series", "8 Series", "M2", "M3"],
  "Mercedes-Benz" => ["C-Class", "E-Class", "S-Class", "GLC", "GLE", "A-Class", "GLA", "GLB", "GLS", "CLA", "CLS", "AMG GT"],
  "GMC" => ["Sierra 1500", "Acadia", "Terrain", "Yukon", "Canyon", "Savana", "Yukon XL", "Sierra HD"],
  "Ram" => ["1500", "2500", "3500", "ProMaster", "ProMaster City", "Dakota"],
  "Hyundai" => ["Elantra", "Sonata", "Santa Fe", "Tucson", "Kona", "Palisade", "Veloster", "Ioniq", "Venue"],
  "Lexus" => ["RX", "ES", "NX", "GX", "LX", "IS", "GS", "RC", "UX", "LS"],
  "Volkswagen" => ["Jetta", "Passat", "Tiguan", "Atlas", "Golf", "Beetle", "Arteon", "ID.4"],
  "Audi" => ["A3", "A4", "A6", "Q3", "Q5", "Q7", "Q8", "A8", "e-tron", "RS5"],
  "Kia" => ["Soul", "Sportage", "Sorento", "Optima", "Forte", "Telluride", "Stinger", "Seltos"],
  "Mazda" => ["CX-5", "Mazda3", "Mazda6", "CX-9", "MX-5 Miata", "CX-30", "CX-3"],
  "Volvo" => ["XC90", "XC60", "XC40", "S60", "S90", "V60", "V90"],
  "Tesla" => ["Model S", "Model 3", "Model X", "Model Y", "Cybertruck", "Roadster"],
  "Porsche" => ["911", "Cayenne", "Macan", "Panamera", "Taycan", "718 Cayman", "718 Boxster"],
  "Cadillac" => ["Escalade", "XT5", "XT4", "XT6", "CT5", "CT4", "CT6"],
  "Buick" => ["Enclave", "Encore", "Envision", "Regal", "LaCrosse", "Cascada"],
  "Acura" => ["MDX", "RDX", "TLX", "ILX", "NSX", "RLX"],
  "Infiniti" => ["QX60", "Q50", "QX80", "QX50", "Q60", "QX70"],
  "Chrysler" => ["Pacifica", "300", "Voyager", "Aspen"],
  "Lincoln" => ["Navigator", "Aviator", "Corsair", "Nautilus", "MKZ", "Continental"],
  "Land Rover" => ["Range Rover", "Discovery", "Range Rover Sport", "Range Rover Evoque", "Defender", "Discovery Sport"],
  "Jaguar" => ["F-Pace", "XE", "XF", "XJ", "E-Pace", "I-Pace", "F-Type"],
  "Dodge" => ["Charger", "Challenger", "Durango", "Journey", "Grand Caravan"],
  "Mitsubishi" => ["Outlander", "Eclipse Cross", "Mirage", "Outlander Sport", "Lancer"],
  ...
  "Ferrari" => ["488", "812 Superfast", "Portofino", "Roma", "F8 Tributo"],
  "Lamborghini" => ["Huracan", "Aventador", "Urus"],
  "Rolls-Royce" => ["Phantom", "Ghost", "Wraith", "Dawn", "Cullinan"],
  "McLaren" => ["720S", "570S", "600LT", "GT", "765LT"],
  ...
  "Vector" => ["W8", "WX-3"],
  "Saleen" => ["S7", "S1"],
  "Shelby" => ["GT500", "GT350", "Super Snake"],
  ...
  "Daihatsu" => ["Terios", "Sirion", "Copen", "Mira"],
  "Suzuki" => ["Swift", "Vitara", "Jimny", "Baleno"],
  "Proton" => ["Persona", "Saga", "X70", "X50"],
  "Perodua" => ["Myvi", "Axia", "Aruz", "Bezza"],
  "Isuzu" => ["D-Max", "MU-X", "Trooper", "Rodeo"],
  "Hino" => ["Dutro", "Ranger", "500 Series", "700 Series"],
  "Scion" => ["tC", "xB", "FR-S", "iQ"],
  "Daewoo" => ["Matiz", "Nubira", "Lanos", "Leganza"],
  "Geely" => ["Emgrand", "Atlas", "Coolray", "Icon"],
  "Chery" => ["Tiggo", "Arrizo", "QQ", "Fulwin"],
  "Great Wall" => ["Haval H6", "Wingle", "Hover", "Steed"],
  "Brilliance" => ["V5", "H530", "V7", "M2"],
  "Dongfeng" => ["Fengshen", "Joyear", "Rich", "AX7"],
  "Zotye" => ["T600", "SR9", "Z500", "E200"],
  "JAC" => ["Refine", "S3", "S5", "J7"],
  "Changan" => ["CS35", "CS55", "Eado", "Raeton"],
  "BAIC" => ["BJ40", "Senova", "X55", "EU5"],
  "BYD" => ["Tang", "Han", "Qin", "Song"],
  "Wuling" => ["Hongguang", "Almaz", "Cortez", "Formo"],
  "Mahindra" => ["Scorpio", "Thar", "XUV500", "Bolero"],
  "Maruti Suzuki" => ["Alto", "Swift Dzire", "Baleno", "Vitara Brezza"],
  "Force" => ["Gurkha", "Trax", "One"],
  "Premier" => ["Padmini", "Rio"],
  "Hindustan" => ["Ambassador"],
  "Eicher" => ["Pro 1049", "Pro 3015"],
